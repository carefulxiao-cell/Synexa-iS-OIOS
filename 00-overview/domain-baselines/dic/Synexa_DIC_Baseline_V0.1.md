...
因此，DIC Baseline 的核心作用，是将人的方向、机器的执行、系统的反馈、项目的推进和经验的沉淀，组织成可执行、可追踪、可复盘、可升级的协同秩序。
...
DIC Baseline 不替代《超智科技认知基线 V3.10》，而是在其上位框架下，进一步展开人、AI、Agent、工具、代码、业务系统与真实项目之间的协同运行机制。

⸻

ES.3 DIC 的核心功能

DIC Baseline 至少承担十项核心功能：
...
7. Manus / Codex / Claude Code / Kimi 等外部执行体：用于接收结构化执行包；
...
DIC Baseline 是 Synexa iS 在“数智协同运行层”的专题基线。
...
因此，Nex₂U 适合作为 DIC Baseline 的首个真实验证场。
...
DIC Baseline 的核心价值，不是把工具列全，而是让人和机器在真实项目中形成共同协同秩序，并把问题、规则、判断和经验持续沉淀为可复用资产。

...
| 文件名 | 更新日期 | 状态 |
| :--- | :--- | :--- |
| `AI_Workspace_Architecture_v1.2.md` | 2026-04-08 | ⏳ 待上传 |
| `Synexa_iS_SSADS_Master_Blueprint_v1.4.md` | 2026-04-08 | ⏳ 待上传 |
| `CONTEXT_OS.md` | 2026-04-08 | ⏳ 待上传 |
| `GPT_Project_Instructions_SynexaiS_v26.1.4.md` | 2026-04-08 | ⏳ 待上传 |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **iS-Nex2U** | 智食引擎 | L2 | Step 3 (业务结构建模) | 🟢 推进中 | 治理智能体 | 将非结构化健康餐饮逻辑转化为可计算的规则引擎 |
| **iS-Synexa** | 超智建设 | L1 | 待启动 | ⚪ 待立项 | 待定 | 超智品牌与系统本身的建设与对外表达 |
| **iS-Nexsply** | 意臻供应链 | L2 | 待启动 | ⚪ 待立项 | 待定 | 全球优质原材料采购与供应链整合 |
| **iS-BG** | Bella Giornata | L2 | 持续运营 | 🔵 运行中 | 待定 | 生活方式导向的现代意餐与轻社交复合空间 |
| **iS-SOP** | 规程资产库 | L3 | 待启动 | ⚪ 待立项 | iS-Matrix | 生产并维护全体系的 SOP 与操作规程 |
...
* **各待立项项目启动**：iS-Synexa、iS-Nexsply、iS-BG、iS-SOP 需要在 iS-Core 完成最小定义后正式立项。

...
超智是整个体系的母品牌与中央协同汇聚层。对内，超智负责七大业务引擎·中台之间的数据互通、资源调度与协同逻辑；对外，超智是所有产品线的品牌背书来源。超智的价值不在于直接提供业务服务，而在于让七个独立引擎产生「1+1+…+1 > 7」的协同效能。
...
**七大引擎·中台与超级系列对应关系（v2.6 更新版 · 2026-04-26 iS-Core 裁决）**

> 2026-04-26 裁决：引擎由四大扩展为七大，新增 NexMPC（人力）、NexFA（财务）；Nexsply 定位升级为供应链智能中台（全链路）；Nex2U / NexChef 架构关系明确（见备注）。

| 引擎·中台（内部定位） | 超级系列产品（对外品牌） | 主题定位 | 典型服务对象 | 备注 |
|---------------------|----------------------|---------|------------|------|
| **NexFlow** | 超级项目管理 | 一站式项目协同智能平台 | 各行业复杂项目团队、工程管理、开业筹备、光伏/广告等专项项目 | 排头位引擎，几乎所有新业务启动均需托底 |
| **Nex2U** | 超级健康管理 | 健康餐食全局规则与管理平台 | 医疗机构、养老院、健康管理机构（B端决策层） | 规则 SSOT，面向 B 端决策层与技术对接方；后台系统归属此引擎 |
| **NexChef** | 超级餐食服务 | 健康餐食点餐与服务交互平台 | C端消费者、B端客户操作层（点餐/出品） | Nex2U 下游应用出口，含点餐系统，不自建规则；前端系统归属此引擎 |
| **Nexsply** | 超级供应链管理 | 供应链智能中台（全链路） | 餐饮企业、制造业、零售供应链 | 全链路：选品、采购、库存、配送 |
| **NexMPC** | 超级人力管理 | 人力资源结构化管理引擎 | 各类组织的人员配置与数字员工协同 | 新增，待立项 |
| **NexFA** | 超级财务管理 | 业务财务结构化管理引擎 | 各类业务的财务健康度监控与成本管理 | 新增，待立项 |
| **iS-Synexa（超智建设）** | — | 品牌体系建设与对外表达 | — | 官网、视觉规范、对外叙事框架 |

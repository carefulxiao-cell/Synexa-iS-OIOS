...
**维护方**：iS-Core（智核中枢）
**最后更新**：2026-07-02（目录架构升级至 G/A/E/S³/P 五层对齐）
...
| `S3_Neural/` | **S³ 层（协同神经体层）** | SOP（标准流程）+ Skill（能力资产）+ Sync（ISYNC 指令同步） |
...
| 文件 | 说明 |
|---|---|
| `G_Governance/context-os/CONTEXT_OS.md` | **全局状态总账本**（任何 AI 接入必读） |

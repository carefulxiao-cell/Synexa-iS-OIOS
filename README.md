...
├── 01-master-blueprint/  ← 总纲·制度母法（SSADS v1.2）
├── 03-projects/
│   └── Nex2U/            ← 智食引擎·Nex₂U（首个实战验证样板）
...
| `03-projects/Nex2U/EP/Nex2U_Step3_Execution_Protocol_v0.2.md` | Step 3 执行协议 | L3 EP |

## AI 接入协议

任何 AI 智能体接入本体系时，必须首先读取：
`00-overview/Synexa_iS_Overview.md`

---

*Synexa iS · OIOS · 内部治理名：SSADS*

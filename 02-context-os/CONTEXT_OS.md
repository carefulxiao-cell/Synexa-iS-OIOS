...
| **iS-NexFlow** | 一站式项目协同智能平台 | **G·集团级**（正式裁决） | 迭代推演中（V2.6 实战验证） | 🟢 推进中 | iS-SCO | 将项目执行过程中所有信息流统一纳管，「信息不出系统」 |
...
* **【一站项管·iS-NexFlow】PCS 专栏建立**：iS-Core 已授权，待用户在对应平台建立专属对话组并按 PCS Briefing V0.6 第6.3节补充系统提示词。

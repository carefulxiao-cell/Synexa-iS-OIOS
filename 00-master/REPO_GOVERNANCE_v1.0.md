...
| 名称 | 类型 | 词根来源 | 说明 | 状态 |
|---|---|---|---|---|
| **Synexa** | 公司品牌 | Synergy + Intelligence | 协同智能融合造词 | 🟢 已确认 |
| **Synexa iS** | 系统品牌 | Intelligence System | 协同智能系统 | 🟢 已确认 |
| **iS-Core** | 治理入口代号 | — | 董事会·主控入口 | 🟢 已确认 |
| **iS-Cortex** | 协同皮层 | 拉丁 cortex | 大脑皮层，经验与规则沉淀 | 🟢 已确认 |
| **iS-Proxima** | 近场智能 | 拉丁 proxima | 最近的，在最近处发生 | 🟢 已确认 |
| **iS-Vena** | 协同数据脉 | 拉丁 vena | 静脉/矿脉，汇聚有价值资源的通道 | 🟢 已确认 |
| **Nexsply** | 子品牌 | Next + Supply | 下一代供应 | 🟢 已确认 |
| **Nex₂U** | 产品代号 | Next to You | 面向用户的协同引擎 | 🟢 已确认 |
| **DICB** | 领域基线代号 | Digital-Intelligence Collaboration Baseline | DIC 领域基线 | 🟢 已确认 |
